...
export async function POST(request: Request) {
  try {
    ...
    // Role + write-tier gate runs BEFORE any parse work. It was previously
    // reached only inside bulkImportCOGRecords, so a vendor-portal or
    // read-only user could drive a full server-side parse of an arbitrary
    // file they could never actually import.
