...
export function PriceDiscrepancyClient() {
  // Server prefetched into a HydrationBoundary in page.tsx, so this
  // query is hot on first render (no loading flash on hard navigation).
