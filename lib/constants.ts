...
export const vendorNav: NavItem[] = [
  ...
  { label: "My Contracts", href: "/vendor/contracts", icon: "FileText" },
...
export const adminNav: NavItem[] = [
  ...
  { label: "Payor Contracts", href: "/admin/payor-contracts", icon: "CreditCard" },
...
export const contractStatusConfig: Record<string, StatusConfig> = {
  ...
  pending: { label: "Pending", variant: "secondary", className: "bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300" },
  // PendingContract submission statuses — the vendor contract list renders
  // submissions through the same badge (vendor tabs fix, 2026-06-10).
  submitted: { label: "Submitted", variant: "secondary", className: "bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300" },
  rejected: { label: "Rejected", variant: "secondary", className: "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300" },
  revision_requested: { label: "Revision Requested", variant: "secondary", className: "bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-300" },
  withdrawn: { label: "Withdrawn", variant: "secondary", className: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300" },
}
...
// (both mean "ball is in the vendor's court"). See plan W1.3.
