...
export const TermTypeSchema = z.enum(["spend_rebate", "volume_rebate", "price_reduction", "market_share", "market_share_price_reduction", "capitated_price_reduction", "capitated_pricing_rebate", "po_rebate", "carve_out", "payment_rebate", "compliance_rebate", "fixed_fee", "locked_pricing", "rebate_per_use"])
