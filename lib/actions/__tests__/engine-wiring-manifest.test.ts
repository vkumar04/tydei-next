...
const MANIFEST: EngineWiring[] = [
  {
    ...
    status: "wired",
    note: "Covered via lib/contracts/capital-schedule-aggregate.ts (aggregatePerItemSchedules), the pure helper the capital-schedule/projection actions in lib/actions/contracts/tie-in.ts call; wiring test: contract-term-amortization-shape.test.ts",
  },
  {
