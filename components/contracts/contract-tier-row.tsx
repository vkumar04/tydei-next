 ...
 */
// Bug #16 (2026-05-08, Vick iMessage): re-enabled "% of Spend" on
// market_share. Bug #17 (2026-05-08, Vick): re-enabled "% of Spend"
// on volume_rebate now that `recomputeVolumeFromCogRecords`
// (lib/contracts/recompute/volume.ts) computes a per-period dollar
// base from in-scope COG records and dispatches per-tier on
