...
import { getVendorRebateBreakdownByType } from "@/lib/actions/vendor-reports/by-rebate-type"

/**
 * Vendor "By Rebate Type" tab — mirror of the facility
 * `ReportsByRebateTypeTab`. Reads persisted Rebate rows across the
 * vendor's contracts and attributes each to the writer that produced it
 * (spend / volume / PO / threshold / invoice / manual).
 */
