...
/**
 * Vendor Overview tab — mirror of the facility `ReportsOverviewTab`.
 * Lifecycle pie + monthly spend/rebate bars + top-line stats, scoped to
 * the calling vendor's contracts across every facility they serve. Data
 * from `getVendorReportsOverview`.
 */
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <StatCard
          ...
          value={String(data.stats.totalContracts)}
        />
        <StatCard
